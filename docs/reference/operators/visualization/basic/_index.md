...
| [Line Chart](line-chart/) | View the result in line chart |
| [Pie Chart](pie-chart/) | Visualize data in a Pie Chart |
| [Range Slider](range-slider/) | Visualize data in a Range Slider |
| [Sankey Diagram](sankey-diagram/) | Visualize data using a Sankey diagram |
| [Scatter Plot](scatter-plot/) | View the result in a scatterplot |
| [Tables Plot](tables-plot/) | Visualize data in a table chart. |
| [Time Series Plot](time-series-plot/) | Visualize trends and patterns over time. |
