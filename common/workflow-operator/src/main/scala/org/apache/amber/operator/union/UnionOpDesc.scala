...
package org.apache.amber.operator.union
...
import org.apache.amber.core.workflow.{InputPort, OutputPort, PhysicalOp, PortIdentity}
  ...
  override def getPhysicalOp(
    ...
    PhysicalOp
      .oneToOnePhysicalOp(
        ...
        executionId,
        operatorIdentifier,
        OpExecWithClassName("org.apache.amber.operator.union.UnionOpExec")
      )
