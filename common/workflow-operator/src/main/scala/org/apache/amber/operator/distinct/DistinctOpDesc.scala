...
import org.apache.amber.core.workflow.{HashPartition, InputPort, OutputPort, PhysicalOp}
  ...
  override def getPhysicalOp(
    ...
    PhysicalOp
      .oneToOnePhysicalOp(
        ...
        executionId,
        operatorIdentifier,
        OpExecWithClassName("org.apache.amber.operator.distinct.DistinctOpExec")
      )
