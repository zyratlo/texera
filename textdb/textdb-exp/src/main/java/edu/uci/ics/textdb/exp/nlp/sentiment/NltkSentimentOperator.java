...
//    private static String PYTHONSCRIPT = "/classifier-loader_V2.py";
    ...
    public static String testResultPath = Utils.getResourcePath("test-result-id-class.csv", TextdbProject.TEXTDB_EXP);
...
//	    String[] entries = "first#second#third".split("#");
	  //  String[] entrites = ("2222222#&#"+inputText).split("#&#");
	  //  writer.writeNext(entrites);
	  //  writer.close();
...
//        args.addAll(new ArrayList<String>(Arrays.asList(text)));
	  ...
	  //Build reader instance
	    CSVReader reader = new CSVReader(new FileReader(resultPath), ',', '"', 1);
	...
	public Tuple getNextTuple() throws TextDBException {
	    ...
	    if (tupleBuffer == null){
    	    ...
    	    while ((tuple = inputOperator.getNextTuple()) != null && i < predicate.getSizeTupleBuffer()) {
    	        ...
    	        tmp[0] = tuple.getField(SchemaConstants._ID).getValue().toString();
    	        tmp[1] = tuple.<IField>getField(predicate.getInputAttributeName()).getValue().toString();
    	        csvData.add(tmp);
    	        i++;
    	    }
        ...
        System.out.println(tupleBuffer.size());
