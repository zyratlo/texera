 ...
 * RE2J's varaibles are declared at package-level, which means we need to be in the same package to access them. <br>
 * See <a href='http://docs.oracle.com/javase/tutorial/java/javaOO/accesscontrol.html'>Java Access Control</a> for different Java access levels. <br>
 * <br>
 * We considered various solutions, including copying all RE2J's source code into our codebase, 
