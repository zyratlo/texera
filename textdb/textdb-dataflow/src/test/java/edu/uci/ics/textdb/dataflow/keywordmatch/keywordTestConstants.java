...
//    			new TextField("This report describes four cases of chronic meningococcemia with the characteristic manifestations of recurrent episodes of fever, chills, night sweats, headache and anorexia, associated with skin rash and arthralgias. The diagnosis was established in all instances by blood culture. Administration of sulfonamides in three cases and penicillin in the fourth resulted in prompt recovery. The recent finding of a strain of sulfonamide-resistant meningococci, however, indicates that antibiotic-sensitivity tests should be carried out in all cases of meningococcal disease. While waiting for the results of such tests to be reported, the clinician should initiate treatment with large doses of a sulfonamide and penicillin in combination.")};
       	...
       	IField [] fields1 = {new IntegerField(14347980), new TextField(""), new TextField("CHRONIC MENINGOCOCCEMIA; EPIDEMIOLOGY, DIAGNOSIS AND TREATMENT."),
    			...
    			new TextField("This report describes four cases of chronic meningococcemia with the characteristic manifestations of recurrent episodes of "
    					...
    					+ "initiate treatment with large doses of a sulfonamide and penicillin in combination."), new DoubleField(0.664347980)};
	    ...
	    IField [] fields3 = {new IntegerField(4566015), new TextField(""), new TextField("Significance of milk pH in newborn infants."), 
