...
public class NumberMatcherTest {
    ...
    public List<ITuple> getDoubleQueryResults(double threshold, Attribute attribute, NumberMatchingType operatorType)
            throws DataFlowException {
        // Perform the query
        NumberPredicate numberPredicate = new NumberPredicate(threshold, attribute, operatorType);
        return getNumberQueryResults(numberPredicate);
    }

    public List<ITuple> getIntegerQueryResults(double threshold, Attribute attribute, NumberMatchingType operatorType)
            throws DataFlowException {
        // Perform the query
        NumberPredicate numberPredicate = new NumberPredicate(threshold, attribute, operatorType);
        return getNumberQueryResults(numberPredicate);
    ...
    public List<ITuple> getNumberQueryResults(NumberPredicate numberPredicate) throws DataFlowException {
        // Perform the query
        NumberMatcher numberMatcher = new NumberMatcher(numberPredicate);
        ScanBasedSourceOperator sourceOperator = getScanSourceOperator(dataStore);
        numberMatcher.setInputOperator(sourceOperator);

        numberMatcher.open();
        numberMatcher.setLimit(Integer.MAX_VALUE);
        numberMatcher.setOffset(0);

        List<ITuple> returnedResults = new ArrayList<>();
        ITuple nextTuple = null;

        while ((nextTuple = numberMatcher.getNextTuple()) != null) {
     ...
     */
    @Test
    public void testNumberMatcher1() throws Exception {
        // Prepare the query
        double threshold = 6.05;
        Attribute attribute = TestConstants.HEIGHT_ATTR;
        NumberMatchingType operatorType = NumberMatchingType.GREATER_THAN;

        // Perform the query
        List<ITuple> returnedResults = getDoubleQueryResults(threshold, attribute, operatorType);
    ...
    @Test
    public void testNumberMatcher2() throws Exception {
        // Prepare the query
        double threshold = 5.75;
        Attribute attribute = TestConstants.HEIGHT_ATTR;
        NumberMatchingType operatorType = NumberMatchingType.LESS_THAN;
    ...
    @Test
    public void testNumberMatcher3() throws Exception {
        // Prepare the query
        double threshold = 5.95;
        Attribute attribute = TestConstants.HEIGHT_ATTR;
        DataConstants.NumberMatchingType operatorType = NumberMatchingType.LESS_THAN_OR_EQUAL_TO;
    ...
    @Test
    public void testNumberMatcher4() throws Exception {
        // Prepare the query
        double threshold = 5.95;
        Attribute attribute = TestConstants.HEIGHT_ATTR;
        NumberMatchingType operatorType = NumberMatchingType.GREATER_THAN_OR_EQUAL_TO;
    ...
    @Test
    public void testNumberMatcher5() throws Exception {
        // Prepare the query
        double threshold = 6.10;
        Attribute attribute = TestConstants.HEIGHT_ATTR;
        NumberMatchingType operatorType = NumberMatchingType.EQUAL_TO;
    ...
    @Test
    public void testNumberMatcher6() throws Exception {
        // Prepare the query
        int threshold = 42;
        ...
        // Perform the query
        List<ITuple> returnedResults = getIntegerQueryResults(threshold, attribute, operatorType);
    ...
    @Test
    public void testNumberMatcher7() throws Exception {
        // Prepare the query
        int threshold = 45;
        Attribute attribute = TestConstants.AGE_ATTR;
        NumberMatchingType operatorType = NumberMatchingType.GREATER_THAN;
    ...
    @Test
    public void testNumberMatcher8() throws Exception {
        // Prepare the query
        int threshold = 45;
        Attribute attribute = TestConstants.AGE_ATTR;
        NumberMatchingType operatorType = NumberMatchingType.GREATER_THAN_OR_EQUAL_TO;
    ...
    @Test
    public void testNumberMatcher9() throws Exception {
        // Prepare the query
        int threshold = 43;
        Attribute attribute = TestConstants.AGE_ATTR;
        NumberMatchingType operatorType = NumberMatchingType.LESS_THAN_OR_EQUAL_TO;
    ...
    @Test
    public void testNumberMatcher10() throws Exception {
        // Prepare the query
        int threshold = 43;
        Attribute attribute = TestConstants.AGE_ATTR;
        NumberMatchingType operatorType = NumberMatchingType.LESS_THAN;
