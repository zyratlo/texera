...
public class JoinTest {
	...
	// types allowed (as of now) are: substring -> SUBSTRING_SCANBASED
	//											   KeywordMatcher
	...
	public void testIdsDontMatch() throws Exception {
		...
		keywordMatcherOuter = (KeywordMatcher) setupOperators(query, "substring", "outer");
		query = "cancer";
		keywordMatcherInner = (KeywordMatcher) setupOperators(query, "substring", "inner");
