...
public class SubstringMatcherTest {
    ...
    /**
     * Verifies Substring Matcher where Query phrase does not exist in any document.
     * @throws Exception
     */
    @Test
    ...
    /**
     * Verifies List<ITuple> returned by Substring Matcher on query
     * with multiple spaces and stop words on a String Field
     * @throws Exception
     */
    @Test
    ...
    /**
     * Verifies: Verifies List<ITuple> returned multiple results by Substring Matcher on query
     * with spaces on both left side and right side.
     * @throws Exception
     */
    @Test
