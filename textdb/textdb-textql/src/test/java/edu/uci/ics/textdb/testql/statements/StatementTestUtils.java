...
public class StatementTestUtils {
    ...
    public static void assertGeneratedBeans(Statement statement, List<OperatorBean> expectedOperators){        
        ...
        // Iterate the graph (string) to look for the expected beans
        ...
        while(true){
            ...
            // Add the outgoing link to the set of visited link and assert it hasn't been visited yet (cycle and duplicate check)
        ...
        // Assert all the links generated by the statement the are visited (no unreachable links)
