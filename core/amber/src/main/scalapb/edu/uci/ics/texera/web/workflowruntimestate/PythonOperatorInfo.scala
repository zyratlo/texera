...
final case class PythonOperatorInfo(
    workerInfo: _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo] = _root_.scala.collection.immutable.Map.empty,
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      workerInfo.foreach { __item =>
        val __value = edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo._typemapper_workerInfo.toBase(__item)
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      workerInfo.foreach { __v =>
        val __m = edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo._typemapper_workerInfo.toBase(__v)
    ...
    def addWorkerInfo(__vs: (_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo)*): PythonOperatorInfo = addAllWorkerInfo(__vs)
    def addAllWorkerInfo(__vs: Iterable[(_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo)]): PythonOperatorInfo = copy(workerInfo = workerInfo ++ __vs)
    def withWorkerInfo(__v: _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo]): PythonOperatorInfo = copy(workerInfo = __v)
    ...
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 1 => workerInfo.iterator.map(edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo._typemapper_workerInfo.toBase(_)).toSeq
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => _root_.scalapb.descriptors.PRepeated(workerInfo.iterator.map(edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo._typemapper_workerInfo.toBase(_).toPMessage).toVector)
...
object PythonOperatorInfo extends scalapb.GeneratedMessageCompanion[edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo = {
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 10 =>
          __workerInfo += edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo._typemapper_workerInfo.toCustom(_root_.scalapb.LiteParser.readMessage[edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry](_input__))
        case 18 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo(
        workerInfo = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Seq[edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry]]).getOrElse(_root_.scala.Seq.empty).iterator.map(edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo._typemapper_workerInfo.toCustom(_)).toMap,
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 1 => __out = edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry
  ...
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]](
      _root_.edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry,
  ...
  final case class WorkerInfoEntry(
      ...
      value: _root_.scala.Option[edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo] = _root_.scala.None
      ...
      def getValue: edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo = value.getOrElse(edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo.defaultInstance)
      def clearValue: WorkerInfoEntry = copy(value = _root_.scala.None)
      def withValue(__v: edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo): WorkerInfoEntry = copy(value = Option(__v))
      def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
        (__fieldNumber: @_root_.scala.unchecked) match {
          case 1 => {
            val __t = key
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToSingleLineUnicodeString(this)
      def companion = edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry
      // @@protoc_insertion_point(GeneratedMessage[edu.uci.ics.texera.web.PythonOperatorInfo.WorkerInfoEntry])
  }
  
  object WorkerInfoEntry extends scalapb.GeneratedMessageCompanion[edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry = {
      var __key: _root_.scala.Predef.String = ""
      var __value: _root_.scala.Option[edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo] = _root_.scala.None
      var _done__ = false
      while (!_done__) {
        val _tag__ = _input__.readTag()
        _tag__ match {
          ...
          case 18 =>
            __value = Option(__value.fold(_root_.scalapb.LiteParser.readMessage[edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
          case tag => _input__.skipField(tag)
        }
      }
      edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry(
          key = __key,
          value = __value
      )
    }
    implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry(
          key = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
          value = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).flatMap(_.as[_root_.scala.Option[edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo]])
        )
      case _ => throw new RuntimeException("Expected PMessage")
    }
    ...
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
      var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
      (__number: @_root_.scala.unchecked) match {
        case 2 => __out = edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo
      }
      __out
    }
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
    lazy val defaultInstance = edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry(
      key = "",
      value = _root_.scala.None
    )
    implicit class WorkerInfoEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry](_l) {
      def key: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.key)((c_, f_) => c_.copy(key = f_))
      def value: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo] = field(_.getValue)((c_, f_) => c_.copy(value = Option(f_)))
      def optionalValue: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo]] = field(_.value)((c_, f_) => c_.copy(value = f_))
    }
    final val KEY_FIELD_NUMBER = 1
    final val VALUE_FIELD_NUMBER = 2
    @transient
    implicit val keyValueMapper: _root_.scalapb.TypeMapper[edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry, (_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo)] =
      _root_.scalapb.TypeMapper[edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry, (_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo)](__m => (__m.key, __m.getValue))(__p => edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry(__p._1, Some(__p._2)))
    def of(
      key: _root_.scala.Predef.String,
      value: _root_.scala.Option[edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo]
    ): _root_.edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry = _root_.edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.WorkerInfoEntry(
      key,
      value
    )
    // @@protoc_insertion_point(GeneratedMessageCompanion[edu.uci.ics.texera.web.PythonOperatorInfo.WorkerInfoEntry])
  }
  ...
  object EvaluateExprResultsEntry extends scalapb.GeneratedMessageCompanion[edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.EvaluateExprResultsEntry] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.javaDescriptor.getNestedTypes().get(1)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo.scalaDescriptor.nestedMessages(1)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
      var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
      (__number: @_root_.scala.unchecked) match {
  ...
  implicit class PythonOperatorInfoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.texera.web.workflowruntimestate.PythonOperatorInfo](_l) {
    def workerInfo: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo]] = field(_.workerInfo)((c_, f_) => c_.copy(workerInfo = f_))
  ...
  def of(
    workerInfo: _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.PythonWorkerInfo],
