...
final case class ActorVirtualIdentity(
    ...
    def companion: edu.uci.ics.amber.engine.common.virtualidentity.ActorVirtualIdentity.type = edu.uci.ics.amber.engine.common.virtualidentity.ActorVirtualIdentity
