...
final case class PhysicalOpIdentity(
    ...
    def companion: edu.uci.ics.amber.engine.common.virtualidentity.PhysicalOpIdentity.type = edu.uci.ics.amber.engine.common.virtualidentity.PhysicalOpIdentity
