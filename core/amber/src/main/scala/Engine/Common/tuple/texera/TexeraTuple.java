...
public class TexeraTuple implements Tuple, Serializable {

    private final Schema schema;
    private final ArrayList<Object> fields;

    public TexeraTuple(Schema schema, Object... fields) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TexeraTuple other = (TexeraTuple) obj;
        if (fields == null) {
    ...
    public static TexeraTuple.Builder newBuilder() {
        return new TexeraTuple.Builder();
    }
    ...
    public static class Builder {
         ...
         * @param tuple
         */
        public Builder(TexeraTuple tuple) {
            checkNotNull(tuple);
         ...
         */
        public static List<TexeraTuple> add(Iterable<TexeraTuple> tuples, Attribute attribute, Object field) throws RuntimeException {
            checkNotNull(tuples);
            tuples.forEach(tuple -> checkNotNull(tuple));
            checkNotNull(attribute);

            return Streams.stream(tuples)
                    .map(tuple -> new TexeraTuple.Builder(tuple))
         ...
         * @throws RuntimeException, if the attribute already exists, or the attribute and field don't match
         */
        public static List<TexeraTuple> add(Iterable<TexeraTuple> tuples, String attributeName, AttributeType attributeType, Object field) {
            checkNotNull(tuples);
            tuples.forEach(tuple -> checkNotNull(tuple));
            checkNotNull(attributeName);
            checkNotNull(attributeType);
         ...
         */
        public static List<TexeraTuple> add(Iterable<TexeraTuple> tuples, Iterable<Attribute> attributes, Iterable<Object> fields) {
            checkNotNull(tuples);
            tuples.forEach(tuple -> checkNotNull(tuple));
            checkNotNull(attributes);
            attributes.forEach(attr -> checkNotNull(attr));
         ...
         * @throws RuntimeException, if the attribute doesn't exist.
         */
        public static List<TexeraTuple> remove(Iterable<TexeraTuple> tuples, String attribute) throws RuntimeException {
            checkNotNull(tuples);
            tuples.forEach(tuple -> checkNotNull(tuple));
            checkNotNull(attribute);
         ...
         */
        public static List<TexeraTuple> remove(Iterable<TexeraTuple> tuples, Iterable<String> attributes) {
            checkNotNull(tuples);
            tuples.forEach(tuple -> checkNotNull(tuple));
            checkNotNull(attributes);
            attributes.forEach(attr -> checkNotNull(attr));
         ...
         * @throws RuntimeException, if one of the attributes doesn't exist in the tuples.
         */
        public static List<TexeraTuple> remove(Iterable<TexeraTuple> tuples, String... attributes) {
         ...
         */
        public static List<TexeraTuple> removeIfExists(Iterable<TexeraTuple> tuples, String attribute) {
            checkNotNull(tuples);
            tuples.forEach(tuple -> checkNotNull(tuple));
            checkNotNull(attribute);
         ...
         * @return a list of newly created tuples, with the attributes removed (if they exist)
         */
        public static List<TexeraTuple> removeIfExists(Iterable<TexeraTuple> tuples, Iterable<String> attributes) {
            checkNotNull(tuples);
            tuples.forEach(tuple -> checkNotNull(tuple));
            checkNotNull(attributes);
            attributes.forEach(attr -> checkNotNull(attr));
         ...
         * @return a list of newly created tuples, with the attributes removed (if they exist)
         */
        public static List<TexeraTuple> removeIfExists(Iterable<TexeraTuple> tuples, String... attributes) {
