...
public class PythonUDFOperatorExecutor implements OperatorExecutor {
    ...
    PythonUDFOperatorExecutor(String pythonScriptFile, ArrayList<String> inputColumns, ArrayList<String> outputColumns,
