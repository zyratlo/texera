...
public class TexeraLocalFileScanTupleProducer implements TupleProducer {
    ...
    TexeraLocalFileScanTupleProducer(String localPath, long startOffset, long endOffset, char delimiter, int[] indicesToKeep) {
