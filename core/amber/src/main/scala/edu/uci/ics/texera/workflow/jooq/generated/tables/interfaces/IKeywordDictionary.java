...
public interface IKeywordDictionary extends Serializable {
     ...
     */
    public void from(edu.uci.ics.texera.workflow.jooq.generated.tables.interfaces.IKeywordDictionary from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IKeywordDictionary
     */
    public <E extends edu.uci.ics.texera.workflow.jooq.generated.tables.interfaces.IKeywordDictionary> E into(E into);
}
