...
public interface IFile extends Serializable {
     ...
     */
    public void from(edu.uci.ics.texera.workflow.jooq.generated.tables.interfaces.IFile from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IFile
     */
    public <E extends edu.uci.ics.texera.workflow.jooq.generated.tables.interfaces.IFile> E into(E into);
}
