...
public class WorkflowExecutionsRecord extends UpdatableRecordImpl<WorkflowExecutionsRecord> implements Record10<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, String>, IWorkflowExecutions {

    private static final long serialVersionUID = -1086260516;
    ...
    @Override
    public Row10<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, String> valuesRow() {
    ...
    @Override
    public WorkflowExecutionsRecord values(UInteger value1, UInteger value2, UInteger value3, Byte value4, String value5, Timestamp value6, Timestamp value7, Byte value8, String value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowExecutionsRecord(UInteger eid, UInteger vid, UInteger uid, Byte status, String result, Timestamp startingTime, Timestamp lastUpdateTime, Byte bookmarked, String name, String environmentVersion) {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS);
