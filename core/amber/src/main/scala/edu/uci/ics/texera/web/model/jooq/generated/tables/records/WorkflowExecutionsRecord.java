...
public class WorkflowExecutionsRecord extends UpdatableRecordImpl<WorkflowExecutionsRecord> implements Record10<UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, UInteger, UInteger>, IWorkflowExecutions {

    private static final long serialVersionUID = -1735233503;
    ...
    @Override
    public Row10<UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, UInteger, UInteger> valuesRow() {
    ...
    @Override
    public WorkflowExecutionsRecord values(UInteger value1, UInteger value2, Byte value3, String value4, Timestamp value5, Timestamp value6, Byte value7, String value8, UInteger value9, UInteger value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowExecutionsRecord(UInteger eid, UInteger vid, Byte status, String result, Timestamp startingTime, Timestamp lastUpdateTime, Byte bookmarked, String name, UInteger uid, UInteger sid) {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS);
