...
public class WorkflowExecutionsRecord extends UpdatableRecordImpl<WorkflowExecutionsRecord> implements Record12<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, String, String, UInteger>, IWorkflowExecutions {

    private static final long serialVersionUID = -376962722;
    ...
    @Override
    public Row12<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, String, String, UInteger> fieldsRow() {
        return (Row12) super.fieldsRow();
    }

    @Override
    public Row12<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, String, String, UInteger> valuesRow() {
    ...
    @Override
    public WorkflowExecutionsRecord value12(UInteger value) {
        setEnvironmentEid(value);
        return this;
    }

    @Override
    public WorkflowExecutionsRecord values(UInteger value1, UInteger value2, UInteger value3, Byte value4, String value5, Timestamp value6, Timestamp value7, Byte value8, String value9, String value10, String value11, UInteger value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowExecutionsRecord(UInteger eid, UInteger vid, UInteger uid, Byte status, String result, Timestamp startingTime, Timestamp lastUpdateTime, Byte bookmarked, String name, String environmentVersion, String logLocation, UInteger environmentEid) {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS);
