...
public class WorkflowExecutionsRecord extends UpdatableRecordImpl<WorkflowExecutionsRecord> implements Record8<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte>, IWorkflowExecutions {

    private static final long serialVersionUID = -1894405613;
    ...
    @Override
    public Row8<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte> valuesRow() {
    ...
    @Override
    public WorkflowExecutionsRecord values(UInteger value1, UInteger value2, UInteger value3, Byte value4, String value5, Timestamp value6, Timestamp value7, Byte value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowExecutionsRecord(UInteger eid, UInteger wid, UInteger vid, Byte status, String result, Timestamp startingTime, Timestamp completionTime, Byte bookmarked) {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS);
