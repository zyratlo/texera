...
public class WorkflowExecutionsRecord extends UpdatableRecordImpl<WorkflowExecutionsRecord> implements Record11<UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, UInteger, UInteger, String>, IWorkflowExecutions {

    private static final long serialVersionUID = -1101350405;
    ...
    @Override
    public Row11<UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, UInteger, UInteger, String> fieldsRow() {
        return (Row11) super.fieldsRow();
    }

    @Override
    public Row11<UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, UInteger, UInteger, String> valuesRow() {
    ...
    @Override
    public WorkflowExecutionsRecord value3(Byte value) {
        setStatus(value);
        return this;
    }

    @Override
    public WorkflowExecutionsRecord value4(String value) {
        setResult(value);
        return this;
    }

    @Override
    public WorkflowExecutionsRecord value5(Timestamp value) {
    ...
    @Override
    public WorkflowExecutionsRecord value7(Byte value) {
        setBookmarked(value);
        return this;
    }

    @Override
    public WorkflowExecutionsRecord value8(String value) {
        setName(value);
        return this;
    }

    @Override
    public WorkflowExecutionsRecord value9(UInteger value) {
        setUid(value);
        return this;
    }
    ...
    @Override
    public WorkflowExecutionsRecord values(UInteger value1, UInteger value2, Byte value3, String value4, Timestamp value5, Timestamp value6, Byte value7, String value8, UInteger value9, UInteger value10, String value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowExecutionsRecord(UInteger eid, UInteger vid, Byte status, String result, Timestamp startingTime, Timestamp lastUpdateTime, Byte bookmarked, String name, UInteger uid, UInteger sid, String environmentVersion) {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS);
