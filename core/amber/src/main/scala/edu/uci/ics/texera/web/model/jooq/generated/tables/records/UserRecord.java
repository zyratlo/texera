...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record5<String, UInteger, String, String, UserRole>, IUser {

    private static final long serialVersionUID = -1351684590;
    ...
    @Override
    public Row5<String, UInteger, String, String, UserRole> valuesRow() {
    ...
    @Override
    public UserRecord value5(UserRole value) {
        setRole(value);
        return this;
    }

    @Override
    public UserRecord values(String value1, UInteger value2, String value3, String value4, UserRole value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(String name, UInteger uid, String password, String googleId, UserRole role) {
        super(User.USER);
