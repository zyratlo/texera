...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record5<UInteger, String, String, String, UserRole>, IUser {

    private static final long serialVersionUID = 168291952;
    ...
    @Override
    public Row5<UInteger, String, String, String, UserRole> valuesRow() {
    ...
    @Override
    public UserRecord values(UInteger value1, String value2, String value3, String value4, UserRole value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(UInteger uid, String name, String password, String googleId, UserRole role) {
        super(User.USER);
