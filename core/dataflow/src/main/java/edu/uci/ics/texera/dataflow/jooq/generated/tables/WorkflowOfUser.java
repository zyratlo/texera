...
public class WorkflowOfUser extends TableImpl<WorkflowOfUserRecord> {
     ...
     */
    public final TableField<WorkflowOfUserRecord, UInteger> WF_ID = createField(DSL.name("wf_id"), org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.WORKFLOW_OF_USER_PRIMARY, Indexes.WORKFLOW_OF_USER_WF_ID);
    }
    ...
    public UserAccount userAccount() {
        return new UserAccount(this, Keys.WORKFLOW_OF_USER_IBFK_1);
    }
