...
public class WorkflowRecord extends UpdatableRecordImpl<WorkflowRecord> implements Record5<String, UInteger, String, Timestamp, Timestamp> {

    private static final long serialVersionUID = -465451490;
     ...
     */
    public WorkflowRecord(String name, UInteger wfId, String content, Timestamp creationTime, Timestamp lastModifiedTime) {
        super(Workflow.WORKFLOW);
