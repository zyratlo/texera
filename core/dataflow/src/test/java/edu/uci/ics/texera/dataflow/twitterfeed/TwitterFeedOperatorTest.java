...
public class TwitterFeedOperatorTest {
    ...
    private static final String locationNEWYORK = "40.49137,-74.25909, 40.915256, -73.700272";
    ...
    public void testLocation() throws Exception {
        Assert.assertTrue(TwitterFeedTestHelper.inLocation(exactResults, locationNEWYORK));
    }
