...
describe('DynamicSchemaService', () => {
  ...
  it('should validate new dynamic schema with property value and remove newly introduced errors', marbles((m) => {
    const workflowActionService: WorkflowActionService = TestBed.get(WorkflowActionService);
    const dynamicSchemaService: DynamicSchemaService = TestBed.get(DynamicSchemaService);
    ...
    const trigger = m.hot('-a-b-c-', {
        a: () => workflowActionService.addOperator(mockScanPredicate, mockPoint),
        b: () => workflowActionService.setOperatorProperty(mockScanPredicate.operatorID, { tableName: 'testTable' }),
        c: () => dynamicSchemaService.setDynamicSchema(mockScanPredicate.operatorID, newSchema)
    });
    ...
    dynamicSchemaService.getOperatorDynamicSchemaChangedStream().subscribe(
      event => {
