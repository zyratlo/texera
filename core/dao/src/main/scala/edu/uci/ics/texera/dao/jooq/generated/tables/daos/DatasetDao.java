...
public class DatasetDao extends DAOImpl<DatasetRecord, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Dataset, UInteger> {
    ...
    @Override
    public UInteger getId(edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Dataset object) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Dataset> fetchRangeOfDid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Dataset> fetchByDid(UInteger... values) {
     ...
     */
    public edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Dataset fetchOneByDid(UInteger value) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Dataset> fetchRangeOfOwnerUid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Dataset> fetchByOwnerUid(UInteger... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Dataset> fetchRangeOfIsPublic(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Dataset> fetchByIsPublic(Byte... values) {
