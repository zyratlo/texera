...
public class WorkflowDao extends DAOImpl<WorkflowRecord, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Workflow, UInteger> {
    ...
    @Override
    public UInteger getId(edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Workflow object) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Workflow> fetchRangeOfWid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Workflow> fetchByWid(UInteger... values) {
     ...
     */
    public edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Workflow fetchOneByWid(UInteger value) {
