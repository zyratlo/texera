...
public class WorkflowOfUserDao extends DAOImpl<WorkflowOfUserRecord, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowOfUser, Record2<UInteger, UInteger>> {
    ...
    @Override
    public Record2<UInteger, UInteger> getId(edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowOfUser object) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowOfUser> fetchRangeOfUid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowOfUser> fetchByUid(UInteger... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowOfUser> fetchRangeOfWid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowOfUser> fetchByWid(UInteger... values) {
