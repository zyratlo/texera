...
public class WorkflowViewCountDao extends DAOImpl<WorkflowViewCountRecord, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowViewCount, UInteger> {
    ...
    @Override
    public UInteger getId(edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowViewCount object) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowViewCount> fetchRangeOfWid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowViewCount> fetchByWid(UInteger... values) {
     ...
     */
    public edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowViewCount fetchOneByWid(UInteger value) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowViewCount> fetchRangeOfViewCount(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.WorkflowViewCount> fetchByViewCount(UInteger... values) {
