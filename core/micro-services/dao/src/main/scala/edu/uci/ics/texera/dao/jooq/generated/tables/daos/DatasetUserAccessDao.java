...
public class DatasetUserAccessDao extends DAOImpl<DatasetUserAccessRecord, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetUserAccess, Record2<UInteger, UInteger>> {
    ...
    @Override
    public Record2<UInteger, UInteger> getId(edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetUserAccess object) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetUserAccess> fetchRangeOfDid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetUserAccess> fetchByDid(UInteger... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetUserAccess> fetchRangeOfUid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetUserAccess> fetchByUid(UInteger... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetUserAccess> fetchRangeOfPrivilege(DatasetUserAccessPrivilege lowerInclusive, DatasetUserAccessPrivilege upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetUserAccess> fetchByPrivilege(DatasetUserAccessPrivilege... values) {
