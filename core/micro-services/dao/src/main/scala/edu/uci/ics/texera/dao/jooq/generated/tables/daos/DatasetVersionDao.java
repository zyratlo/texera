...
public class DatasetVersionDao extends DAOImpl<DatasetVersionRecord, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetVersion, UInteger> {
    ...
    @Override
    public UInteger getId(edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetVersion object) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetVersion> fetchRangeOfDvid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetVersion> fetchByDvid(UInteger... values) {
     ...
     */
    public edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetVersion fetchOneByDvid(UInteger value) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetVersion> fetchRangeOfDid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetVersion> fetchByDid(UInteger... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetVersion> fetchRangeOfCreatorUid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.DatasetVersion> fetchByCreatorUid(UInteger... values) {
